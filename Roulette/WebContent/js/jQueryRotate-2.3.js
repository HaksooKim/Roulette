...
(function($){
    ...
    Wilq32.PhotoEffect.prototype = {
        _setupParameters : function(parameters){
	        ...
	        this._parameters.tick     = parameters.tick     || this._parameters.tick     || null;
        ...
        _defaultEasing : $.easing[$.easing.def],
        ...
        _rotate : (function(){
	        ...
	        return function(angle){
	        	if(this._parameters.tick){
	        		this._parameters.tick.call(this, angle);
	        	}
	            if(IE){
